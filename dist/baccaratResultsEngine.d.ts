...
declare class BaccaratResultsEngine {
     ...
     */
    static valueForCard({ suit, value }: any): number;
    /**
     ...
     * @return {String}
     */
    calculateNatural(outcome: string, { playerCards, bankerCards }: any): string;
    /**
     * Calculates the winning pair bets for the game.
     * @param {Hand} hand The hand for the baccarat game played.
     * @return {String}
     */
    calculatePairs({ playerCards, bankerCards }: any): string;
    /**
     * @private
     ...
     */
    calculateHandValue(cards?: any[]): number;
}
