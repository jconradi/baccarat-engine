...
class BaccaratResultsEngine {
     ...
     * @returns {GameResult} The game result calculated from the hand.
     */
     ...
     * @param {Card[]} cards A collection of cards to calculate the baccarat hand value for.
     * @return {Number} The card value of the cards.
     */
    calculateHandValue(cards = []) {
        var cardsValue = cards.reduce((handValue, card) => {
